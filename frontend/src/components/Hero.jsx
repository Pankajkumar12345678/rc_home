    ...
    <section className="relative min-h-screen overflow-hidden">
        ...
        {heroImages.map((img, index) => (
          <div
            ...
            style={{
              ...
              backgroundSize: "100% 100%",          // cover the container nicely without stretching
      ...
      <div className="relative z-10 min-h-screen flex items-center">
        <div className="container mx-auto px-4 py-5">
          <div className={`mx-auto transition-all duration-1000 ${showContent ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
            }`}>
      ...
      <div className="absolute bottom-8 right-8 flex gap-2">
        {heroImages.map((_, index) => (
          <button
            ...
            className={`w-2 h-2 rounded-full transition-all ${index === currentImageIndex ? 'scale-125 bg-white' : 'bg-white/50'
              }`}
