...
const NearbyPlaces = () => {
    ...
    const pgLocation = {
        ...
        address: "215, North, behind Dalda Factory, near Hyde Park, Arjun Nagar, Vasundhara Colony, Durgapura, Jaipur, Rajasthan 302018",
        lat: 26.8476033,
        lng: 75.7872892,
    ...
    const mapEmbedUrl = `https://maps.google.com/maps?q=RC%20HOMES%20PG%20FOR%20GIRLS%20Durgapura%20Jaipur&t=&z=15&ie=UTF8&iwloc=&output=embed`;
                ...
                >
                    {places.map((place, index) => (
                        <motion.div
                            ...
                            className={`relative group cursor-pointer bg-white/90 backdrop-blur-sm rounded-2xl p-5 border-2 transition-all duration-300 ${selectedPlace === index
                ...
                >
                    <div className="bg-white/90 backdrop-blur-md rounded-3xl p-4 md:p-6 border border-gray-100 shadow-2xl relative overflow-hidden">
                        ...
                        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-4 px-2">
                            ...
                            {/* Google Maps Button */}
                            <a
                                href="https://maps.google.com/maps?q=RC%20HOMES%20PG%20FOR%20GIRLS%20Durgapura%20Jaipur&t=&z=15&ie=UTF8&iwloc=&output=embed"
                                target="_blank"
                    ...
                    <div className="bg-gradient-to-r from-orange-500 via-amber-500 to-orange-500  rounded-2xl p-6 shadow-2xl relative overflow-hidden">
                        ...
                        <div className="relative z-10 flex flex-col sm:flex-row items-center justify-between gap-6">
                            ...
                            <div className="flex flex-wrap gap-3">
                                <a
                                    href={`https://www.google.com/maps/dir/?api=1&destination=${pgLocation.lat},${pgLocation.lng}&travelmode=driving`}
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="inline-flex items-center gap-2 px-6 py-3 bg-white text-blue-600 font-semibold rounded-full"
                                >
                                    <Car size={18} />
                                    <span>Drive</span>
                                </a>
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="inline-flex items-center gap-2 px-6 py-3 bg-white/20 border-2 border-white/50 font-semibold rounded-full"
                                >
                                    <Footprints size={18} />
                                    <span>Walk</span>
                                </a>
