...
const ContactCTA = () => {
  ...
  const stats = [
    { icon: <Users size={20} />, value: '200+', label: 'Happy Girls' },
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            >
              ...
              <p className="text-white/90 text-lg">
                Only <span className="font-bold text-yellow-200">4 rooms</span> left for this month. 
                Book a visit now and get 
              </p>
              ...
              <div className="space-y-4 pt-4">
                <div className="flex items-center gap-3 group">
                  ...
                  <span className="text-white/90">215, North, behind Dalda Factory, near Hyde Park, Arjun Nagar, Vasundhara Colony, Durgapura, Jaipur, Rajasthan 302018</span>
                  <button 
