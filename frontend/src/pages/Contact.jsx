...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: <MapPin size={24} />,
      title: 'Location',
      details: ["215, North,", "behind Dalda Factory,", "Durgapura, Jaipur,", "Rajasthan 302018"],
  ...
  const faqs = [
    {
      ...
      answer: 'Check-in time is 6:00 AM and check-out time is 11:00 PM. Early check-in and late check-out can be arranged upon request.'
    },
    {
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex items-center justify-between pt-4">
                      ...
                      <button
                        ...
                        className={`px-8 py-3 rounded-lg font-medium transition-all duration-300 flex items-center gap-2 ${isSubmitting
              ...
              <div className="absolute bottom-4 left-4 bg-white/90 backdrop-blur-sm rounded-xl p-4 shadow-lg max-w-xs">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">215, North,
                      behind Dalda Factory,
                      Durgapura, Jaipur,
                      Rajasthan 302018</p>
                  </div>
                </div>
                <a target='_blank' href='https://www.google.com/maps/place/RC+HOMES+PG+FOR+GIRLS/@26.847603,75.787289,15z/data=!4m6!3m5!1s0x396db5a9ddcdd0e3:0x7af00fb2cf097283!8m2!3d26.8476033!4d75.7872892!16s%2Fg%2F11vcl98ch0?hl=en-US&entry=ttu&g_ep=EgoyMDI2MDIxMS4wIKXMDSoASAFQAw%3D%3D' className="w-full mt-2 px-4 py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white text-sm rounded-lg font-medium hover:shadow-md transition-all duration-300">
                  Get Directions
                </a>
              </div>
            </div>
        ...
        <div className="bg-gradient-to-r from-red-500 to-orange-500 rounded-2xl p-6 md:p-8 text-white shadow-xl">
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="text-center md:text-right">
              <div className="text-3xl font-bold mb-1">+ 916377964494</div>
