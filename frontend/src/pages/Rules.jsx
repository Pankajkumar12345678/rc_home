...
const Rules = () => {
  ...
  const rules = [
    {
      id: 1,
      title: "General Conduct & Respect",
      icon: <Heart size={24} />,
      color: "from-pink-500 to-rose-500",
      bgColor: "bg-pink-50",
      borderColor: "border-pink-200",
      stats: { value: "Respect", label: "First Priority" },
      items: [
        { text: "Respect Privacy - Always knock before entering other rooms", strict: true, icon: <Eye size={14} /> },
        { text: "No snooping or interference in others' matters", strict: true, icon: <Ban size={14} /> },
        { text: "Keep noise low, especially late night or early morning", strict: true, icon: <VolumeX size={14} /> },
        { text: "Keep your room and common areas tidy", strict: false, icon: <Trash2 size={14} /> },
        { text: "Dispose of trash properly", strict: true, icon: <Trash2 size={14} /> },
        { text: "Be respectful to owner, staff, and fellow residents", strict: true, icon: <MessageCircle size={14} /> },
        { text: "Treat everyone equally regardless of background/religion/caste", strict: true, icon: <Users2 size={14} /> }
      ],
      description: "Basic respect and consideration for everyone ensures a harmonious living environment.",
      penalty: "Disrespectful behavior may lead to warning or termination",
      emergency: "Report concerns to owner immediately"
    },
    {
      id: 2,
      ...
      stats: { value: "6 AM - 11 PM", label: "Timing" },
      items: [
        { text: "Entry: 6:00 AM to 11:00 PM only", strict: true, icon: <DoorOpen size={14} /> },
        { text: "Exit: 6:00 AM to 11:00 PM only", strict: true, icon: <DoorOpen size={14} /> },
        { text: "Notify owner if you'll be late", strict: true, icon: <Bell size={14} /> },
        { text: "Stick to entry/exit times strictly", strict: true, icon: <Clock size={14} /> }
      ],
      description: "Timings are strictly enforced for everyone's safety and security.",
      penalty: "Repeated late entry without notification may lead to warning",
      emergency: "Emergency contact: +91 63779 64494"
    },
    {
      id: 3,
      title: "Guest Policy",
      ...
      stats: { value: "₹300/night", label: "Overnight Guest" },
      items: [
        { text: "Guests require prior permission", strict: true, icon: <UserPlus size={14} /> },
        { text: "Overnight guests charged ₹300 per night", strict: true, icon: <Moon size={14} /> },
        { text: "Excludes mother and siblings (no charge)", strict: false, icon: <Heart size={14} /> },
        { text: "All guests must be registered", strict: true, icon: <Users size={14} /> }
      ],
      ...
      emergency: "Contact owner for guest permission: +91 63779 64494"
    },
    {
      id: 4,
      title: "Food & Utilities",
      icon: <Flame size={24} />,
      color: "from-orange-500 to-red-500",
      bgColor: "bg-orange-50",
      borderColor: "border-orange-200",
      stats: { value: "No Non-Veg", label: "Food Policy" },
      items: [
        { text: "Non-Veg Food - Strictly NOT allowed (including eggs)", strict: true, icon: <Egg size={14} /> },
        { text: "Room lights must be switched off by 11:00 PM", strict: true, icon: <Lightbulb size={14} /> },
        { text: "Use electricity responsibly to avoid wastage", strict: false, icon: <Zap size={14} /> },
        { text: "Use water responsibly to avoid wastage", strict: false, icon: <Droplets size={14} /> }
      ],
      description: "Responsible use of resources and adherence to food policy is mandatory.",
      penalty: "Violation of food policy may lead to strict action",
      emergency: "Report utility issues to maintenance"
    },
    {
      id: 5,
      title: "Notice Period",
      ...
      stats: { value: "15 Days", label: "Notice Required" },
      items: [
        { text: "Provide 15-day notice before vacating", strict: true, icon: <Calendar size={14} /> },
        { text: "Security deposit not refunded if notice period not served", strict: true, icon: <Ban size={14} /> },
        { text: "Plan your move-out accordingly", strict: false, icon: <Info size={14} /> }
      ],
      description: "Notice period policy ensures smooth transition for all parties.",
      penalty: "Loss of security deposit if notice period not served",
      emergency: "Discuss move-out plans with owner in advance"
    }
  ];

  const quickStats = [
    { icon: <Clock size={20} />, value: "6 AM - 11 PM", label: "Entry/Exit Time", color: "from-blue-500 to-cyan-500" },
    { icon: <Users size={20} />, value: "₹300", label: "Overnight Guest", color: "from-purple-500 to-pink-500" },
    { icon: <Ban size={20} />, value: "No Non-Veg", label: "Food Policy", color: "from-orange-500 to-red-500" },
    { icon: <Calendar size={20} />, value: "15 Days", label: "Notice Period", color: "from-gray-700 to-gray-900" }
  ];

  const doList = [
    "Always knock before entering rooms",
    "Keep noise low after 11 PM",
    "Maintain cleanliness in common areas",
    "Notify owner if you'll be late",
    "Get permission for guests",
    "Switch off lights by 11 PM"
  ];

  const dontList = [
    "No snooping or interference",
    "No non-veg food (including eggs)",
    "No overnight guests without permission",
    "No wastage of electricity/water",
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4">
            <span className="block text-gray-800">GENERAL CONDUCT</span>
            <motion.span
          ...
          >
            Please follow these rules to ensure a safe, comfortable, and respectful environment for everyone
          </motion.p>
        </motion.div>
                  ...
                  {rule.items.map((item, idx) => (
                    ...
                    >
                      ...
                      <div className="flex-1 flex items-center gap-2">
                        ...
                        {item.strict && (
                          <span className="text-[10px] px-2 py-0.5 bg-red-100 text-red-600 rounded-full whitespace-nowrap">
                            Strict
                          </span>
                        )}
                      </div>
        ...
        >
          <span className="inline-flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur-sm rounded-full border border-gray-200 shadow-sm">
            ...
            <span className="text-sm text-gray-600">For any queries about rules, contact owner: </span>
